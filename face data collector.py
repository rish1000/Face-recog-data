...
face_cascade = cv2.CascadeClassifier("D:\All downloads\Edge Downloads\haarcascade_frontalface_alt.xml")
...
while True:
    ...
    for face in faces:
        x, y, w, h = face
        #cv2.rectangle(image, (x-padding, y-padding), (x+w+padding, y+h+padding), (0,0,255),2) # draw rectangle on an image(images, start pt)
